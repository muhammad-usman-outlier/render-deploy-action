...
export type DeployQuery = {__typename?: 'Query'} & {
  deploy?: Maybe<
    {__typename?: 'Deploy'} & Pick<Deploy, 'id' | 'status'> & {
        server: {__typename?: 'Server'} & Pick<Server, 'id' | 'url'>
      }
  >
}
...
export type DeploysQuery = {__typename?: 'Query'} & {
  deploys: Array<
    {__typename?: 'Deploy'} & Pick<
      Deploy,
      'id' | 'status' | 'branch' | 'commitId'
...
export type PullRequestServersQuery = {__typename?: 'Query'} & {
  pullRequestServers?: Maybe<
    Array<
      Maybe<
        {__typename?: 'PullRequestServer'} & {
          pullRequest: {__typename?: 'PullRequest'} & Pick<
            PullRequest,
            'number'
          >
          server?: Maybe<{__typename?: 'Server'} & Pick<Server, 'id'>>
        }
      >
    >
  >
...
export type SignInMutation = {__typename?: 'Mutation'} & {
  signIn?: Maybe<{__typename?: 'AuthResult'} & Pick<AuthResult, 'idToken'>>
}
...
export function getSdk(
  ...
  return {
    Deploy(
      variables: DeployQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeployQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DeployQuery>(DeployDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        'Deploy'
    ...
    Deploys(
      variables: DeploysQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<DeploysQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DeploysQuery>(DeploysDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        'Deploys'
    ...
    PullRequestServers(
      variables: PullRequestServersQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<PullRequestServersQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<PullRequestServersQuery>(
            PullRequestServersDocument,
            variables,
